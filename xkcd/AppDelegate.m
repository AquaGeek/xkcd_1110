...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.worldViewController = [[WorldViewController alloc] initWithNibName:@"WorldViewController" bundle:nil];
    self.window.rootViewController = self.worldViewController;
